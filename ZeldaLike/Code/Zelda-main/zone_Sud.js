class Sud extends Phaser.Scene {
    constructor() {
        super("zone_Sud");
    }
    preload() { }
    ...
    create() {
        this.carteDuNiveau = this.add.tilemap("sud");
        this.tileset = this.carteDuNiveau.addTilesetImage(
            "photo",
            "Phaser_tuilesdejeu"
        );
        const calque_south = this.carteDuNiveau.createLayer(
            "sud",
            this.tileset
        );
        calque_south.setCollisionByProperty({ isSolid: true })
